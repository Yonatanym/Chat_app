...
public class MainActivity extends AppCompatActivity {
    ...
    // Preference manager to handle shared preferences
    ...
    /**
     * Set listeners for the buttons and actions in the UI.
     */
    ...
    /**
     * Sign the user out by clearing preferences and updating the FCM token in Firestore.
     */
